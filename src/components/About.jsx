...
const About = ({ refs }) => {
    ...
    return (
        ...
        <div ref={refs} className='min-h-screen overflow-hidden flex items-center justify-center w-[90vw] gap-x-10 mx-auto'>
            <motion.div style={{y, opacity}} className='text-[#F8F4E3] font-fira w-[40%] flex flex-col gap-y-6'>
                <div className=''>
            ...
            <div className='max-w-[30%] group transition-all duration-300 scale-100 hover:scale-105'>
                <ElectricBorder
                    color="#7df9ff"
                    speed={1}
                    chaos={0.5}
                ...
                >
                    <img className='grayscale-100 group-hover:grayscale-0' src="https://i.pinimg.com/736x/0a/01/04/0a0104b34d90ef354feff46d759b7e29.jpg" alt="" />
                </ElectricBorder>
            </div>
        </div>
    );
